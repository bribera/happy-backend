...
export interface ApiCalendrierAcademiqueCalendrierAcademique
  extends Struct.CollectionTypeSchema {
  collectionName: 'calendrier_academiques';
  info: {
    displayName: 'Calendrier_academique';
    pluralName: 'calendrier-academiques';
    singularName: 'calendrier-academique';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    date_fin: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'2025-10-03'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::calendrier-academique.calendrier-academique'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCoursFormationCoursFormation
  extends Struct.CollectionTypeSchema {
  collectionName: 'cours_formations';
  info: {
    displayName: 'Cours-Formation';
    pluralName: 'cours-formations';
    singularName: 'cours-formation';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    calendrier_academiques: Schema.Attribute.Relation<
      'oneToMany',
      'api::calendrier-academique.calendrier-academique'
    >;
...
export interface ApiInscriptionInscription extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_payement: Schema.Attribute.Date & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    payements: Schema.Attribute.Relation<'oneToMany', 'api::payement.payement'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPayementPayement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    date_payement: Schema.Attribute.Date & Schema.Attribute.Required;
    etat: Schema.Attribute.Enumeration<
      ['En cours', 'R\u00E9ussi', 'Echou\u00E9']
    > &
      Schema.Attribute.Required;
    inscription: Schema.Attribute.Relation<
      'manyToOne',
      'api::inscription.inscription'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    montant: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<40000>;
    moyen: Schema.Attribute.Enumeration<
      ['MTN(MobileMoney)', 'Moov(MoovMoney)']
    > &
      Schema.Attribute.Required;
    paye_a: Schema.Attribute.Date;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiRessourcePedagogiqueRessourcePedagogique
  ...
  info: {
    displayName: 'Ressource_pedagogique';
    pluralName: 'ressource-pedagogiques';
    singularName: 'ressource-pedagogique';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    fichiers: Schema.Attribute.Media<
...
export interface ApiStatistiqueStatistique extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'statistiques';
    singularName: 'statistique';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    cours_fini: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    statistiques: Schema.Attribute.Relation<
      'oneToMany',
      'api::statistique.statistique'
    >;
    updatedAt: Schema.Attribute.DateTime;
